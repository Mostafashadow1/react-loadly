# React Loadly Architecture v3.0.0
...
## 🦾 Advanced Engine: AutoSkeletonLoader (v3.0.0)
...
React Loadly v3.0.0 ships with dedicated subpath exports built via Rollup to support tree-shaking:
